...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerComposers(): void {
        ...
        // Roleplay
        this._composers.set(OutgoingHeader.ROLEPLAY_CHARACTER_LOOKUP, CharacterLookupComposer);
        this._composers.set(OutgoingHeader.ROLEPLAY_CHARACTER_ATTRIBUTES_LOOKUP, CharacterAttributesLookupComposer);
        this._composers.set(OutgoingHeader.ROLEPLAY_ATTACK, AttackComposer);
        this._composers.set(OutgoingHeader.ROLEPLAY_CALL_PARAMEDIC, CallParamedicComposer);
        this._composers.set(OutgoingHeader.ROLEPLAY_HEAL, HealComposer);
        this._composers.set(OutgoingHeader.CHARACTER_LOOKUP_ROLEPLAY_ITEMS, CharacterLookupRoleplayItemsComposer);
        this._composers.set(OutgoingHeader.CHARACTER_UPDATE_BY_ID, CharacterUpdateByIdComposer);
        this._composers.set(OutgoingHeader.ROLEPLAY_ITEM_ADD_ONE, RoleplayItemAddOneComposer);
        this._composers.set(OutgoingHeader.ROLEPLAY_ITEM_DELETE_ONE, RoleplayItemDeleteOneComposer);
