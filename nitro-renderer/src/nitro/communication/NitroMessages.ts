...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        ...
        this._events.set(IncomingHeader.ROLEPLAY_CHARACTER_ATTRIBUTES_DATA, CharacterAttributesDataEvent);
    }
