    ...
    return (
      <NitroCardView className="nitro-engraving-lock" theme="primary-slim">
        ...
        <NitroCardContentView>
          <h5 className="text-white text-center fw-bold mt-2 mb-2">{LocalizeText("friend.furniture.confirm.lock.subtitle")}</h5>
          <div className="d-flex justify-content-center mb-2">
            <div className={`engraving-lock-stage-${stage}`}></div>
          </div>
          {stage === 2 && <div className="text-small text-white text-center mb-2">{LocalizeText("friend.furniture.confirm.lock.other.locked")}</div>}
          <Flex gap={1}>
